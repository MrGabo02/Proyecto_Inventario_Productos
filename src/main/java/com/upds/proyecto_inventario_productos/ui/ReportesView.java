...
public class ReportesView extends VerticalLayout{
    public ReportesView() {
        ...
        buttonProveedor.addClickListener( e -> UI.getCurrent().navigate(ReportProveedorView.class));
        add(buttonProveedor);

        /*
        Button buttonCliente = new Button("Cliente");
        buttonCliente.addClickListener( e -> UI.getCurrent().navigate(ReportClienteView.class));
        add(buttonCliente);
        ...
        Button buttonSalida = new Button("Home");
        buttonSalida.addClickListener( e -> UI.getCurrent().navigate(HomeView.class));
        add(buttonSalida);
    }
}
